...
const WhyChose = () => {
  ...
  return (
    <div className="w-11/12 lg:container mx-auto mt-30">
      ...
      <p className="text-2xl font-thin text-center mt-5 max-w-2xl mx-auto">
      ...
      <div className="grid gird-cols-1 md:grid-cols-2 gap-8 mt-10">
        {whyChoseData.map((data, index) => (
          <div key={index} className="flex items-start gap-5 py-6 px-8 border border-gray-300 rounded-2xl hover:shadow-xl">
            <div>
